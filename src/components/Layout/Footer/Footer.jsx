...
import {faFacebook, faTwitter, faInstagram, faVk} from '@fortawesome/free-brands-svg-icons';
      ...
      <div className="footer-top-wrapper">
        <div className="footer-top container">
          <div className="footer-top-child">
            ...
            <p>Адрес:</p>
            <p>
              Интернет-магазин. Для передачи заказа в выбранный вами пункт
      ...
      <div className="footer-bottom-wrapper">
        <div className="footer-bottom container">
          ...
          <div className="footer-bottom-input">
            ...
            <Button style="subscribe-button" text="Подписаться" />
          </div>
